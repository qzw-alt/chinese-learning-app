...
const vocabDict = {
  ...
  '早': { mandarin: { pinyin: 'zǎo', pos: '形容词', meaning: 'early, morning' }, cantonese: { jyutping: 'zou2', pos: '形容词', meaning: 'early, morning' } },
  '晨': { mandarin: { pinyin: 'chén', pos: '名词', meaning: 'morning, dawn' },  cantonese: { jyutping: 'san4', pos: '名词', meaning: 'morning, dawn' } },
  '今': { mandarin: { pinyin: 'jīn', pos: '名词', meaning: 'today, now' },       cantonese: { jyutping: 'gam1', pos: '名词', meaning: 'today, now' } },
  '日': { mandarin: { pinyin: 'rì', pos: '名词', meaning: 'day, sun' },          cantonese: { jyutping: 'jat6', pos: '名词', meaning: 'day, sun' } },
  '点': { mandarin: { pinyin: 'diǎn', pos: '代词', meaning: 'how (in 怎么样)' },   cantonese: { jyutping: 'dim2', pos: '代词', meaning: 'how' } },
  '都': { mandarin: { pinyin: 'dōu', pos: '副词', meaning: 'also, all' },        cantonese: { jyutping: 'dou1', pos: '副词', meaning: 'also, all' } },
  '食': { mandarin: { pinyin: 'shí', pos: '动词', meaning: 'to eat' },           cantonese: { jyutping: 'sik6', pos: '动词', meaning: 'to eat' } },
  '餐': { mandarin: { pinyin: 'cān', pos: '名词', meaning: 'meal' },             cantonese: { jyutping: 'caan1', pos: '名词', meaning: 'meal' } },
  '未': { mandarin: { pinyin: 'wèi', pos: '副词', meaning: 'not yet' },          cantonese: { jyutping: 'mei6', pos: '副词', meaning: 'not yet' } },
  '啦': { mandarin: { pinyin: 'la', pos: '助词', meaning: 'sentence final particle' }, cantonese: { jyutping: 'laa1', pos: '助词', meaning: 'final particle' } },
  '而': { mandarin: { pinyin: 'ér', pos: '连词', meaning: 'and, but' },          cantonese: { jyutping: 'ji4', pos: '连词', meaning: 'and, but' } },
  '边': { mandarin: { pinyin: 'biān', pos: '代词', meaning: 'which (place)' },   cantonese: { jyutping: 'bin1', pos: '代词', meaning: 'which' } },
  '返': { mandarin: { pinyin: 'fǎn', pos: '动词', meaning: 'to return' },        cantonese: { jyutping: 'faan1', pos: '动词', meaning: 'to return, go to' } },
  '工': { mandarin: { pinyin: 'gōng', pos: '名词', meaning: 'work' },            cantonese: { jyutping: 'gung1', pos: '名词', meaning: 'work' } },
  '嘢': { mandarin: { pinyin: 'yě', pos: '名词', meaning: 'thing, stuff' },      cantonese: { jyutping: 'je5', pos: '名词', meaning: 'thing, stuff' } },
  '咁': { mandarin: { pinyin: 'gàn', pos: '连词', meaning: 'so, then' },         cantonese: { jyutping: 'gam2', pos: '连词', meaning: 'so, then' } },
  '忙': { mandarin: { pinyin: 'máng', pos: '形容词', meaning: 'busy' },          cantonese: { jyutping: 'mong4', pos: '形容词', meaning: 'busy' } },
  '先': { mandarin: { pinyin: 'xiān', pos: '副词', meaning: 'first' },           cantonese: { jyutping: 'sin1', pos: '副词', meaning: 'first' } },
  '拜': { mandarin: { pinyin: 'bài', pos: '动词', meaning: 'to bow, bye' },      cantonese: { jyutping: 'baai1', pos: '动词', meaning: 'bye' } },
};
